...
This is a hint that we should instead consider a generalisation of |pr| which prints strings that are necessarily fully balanced.
...
We consider such strings and parsing them in the next section.
